        ...
        static void Main(string[] args)
        {
...

            {
                ...
                while (opcao != 2)
                {
                    ...
                    Console.WriteLine("Robozao");

                    Console.WriteLine("Infome a cordenada X  do robozao");

                    cordX = Convert.ToDouble(Console.ReadLine());

                    Console.WriteLine("Infome a cordenada Y  do robzao");

                    cordY = Convert.ToDouble(Console.ReadLine());


                    Console.WriteLine("Informe a direção incial do robzao ");
                    ...
                    for (int i = 0; i < moverRobo.Length; i++)
                    {
                        ...
                        Console.WriteLine("Informe as cordenadas que o robozao deve seguir");
